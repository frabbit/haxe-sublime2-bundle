...
class TopLevel 
{
    ...
    public static function getLocalVars(ctx:CompletionContext):Array<Tup2<String,String>> 
    {
        var comps = [];
    ...
    public static function getLocalFunctions(ctx:CompletionContext):Array<Tup2<String,String>>
    {
        var comps = [];
    ...
    public static function getLocalFunctionParams(ctx:CompletionContext):Array<Tup2<String,String>>
    {
        var comps = [];
    ...
    public static function getLocalVarsAndFunctions (ctx:CompletionContext):Array<Tup2<String,String>> {
        var comps = [];
    ...
    public static function filterTopLevelCompletions (prefix:String, all_comps:Array<Tup2<String, String>>) 
    {
        var comps = [];
