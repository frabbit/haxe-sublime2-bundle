...
class HxCompletion 
{
    ...
    static function completionResultWithSmartSnippets (view:View, comps:Array<Tup2<String, String>>, result:CompletionResult, options:CompletionOptions) 
    {
    ...
    static function cancelCompletion(view:View, hideComplete = true):Array<Tup2<String,String>> 
    {
        if (hideComplete) 
        {
