...
extern class EventListener {
	...
	public function on_text_command(view:View, command_name:String, args:KwArgs<Dynamic>):Tuple2<String, Array<Dynamic>>;
	...
	// returns 	(new_command_name, new_args)
	public function on_window_command(window:Window, command_name:String, args:KwArgs<Dynamic>):Tuple2<String, Array<Dynamic>>;

	// Called after a text command has been executed.
	public function post_text_command(view:View, command_name:String, args:KwArgs<Dynamic>):Void;

	// Called after a window command has been executed.
	public function post_window_command(window:Window, command_name:String, args:KwArgs<Dynamic>):Void;
