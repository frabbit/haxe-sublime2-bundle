...
class View {
	...
	*/
	...
	public function rowcol(point:Int):Tup2<Int, Int>;
	...
	*/
	public function command_history(index:Int, ?modifying_only:Bool):Tup3<String, Dict<TODO, TODO>, Int>;
	...
	public function symbols(line_endings:String):Array<Tup2<Region, String>>;
